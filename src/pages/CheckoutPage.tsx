...
export default function CheckoutPage() {
  ...
  async function handlePayment() {
    ...
    try {
      ...
      const createOrder = httpsCallable<CreateOrderRequest, CreateOrderResult>(
        functions,
        'createRazorpayOrder'
      );
      ...
      const options: RazorpayOptions = {
        ...
        handler: async (paymentResponse: RazorpayResponse) => {
          try {
            const verifyPayment = httpsCallable<VerifyPaymentRequest, VerifyPaymentResult>(
              functions,
              'verifyRazorpayPayment'
            );
            const { data: verifyResult } = await verifyPayment({
